...
export default function Button({ variant = "primary", size = "md", className, ...rest }: Props) {
  ...
  const variants = {
    primary:
      "bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white shadow hover:brightness-110 focus:ring-indigo-400",
    secondary:
      "bg-white text-gray-900 border shadow-sm hover:bg-gray-50 focus:ring-gray-300",
